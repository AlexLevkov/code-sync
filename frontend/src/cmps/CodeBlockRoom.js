  ...
  return (
    <div className="code-block-cmp animate__animated animate__pulse animate__fadeIn">
      ...
      <h2 className="code-title">
        Dear {userName} welcome to {codeTitle}
      </h2>
      <h2>
        {" "}
        {codeAnswer === codeSolution ? (
          <div className="success-smiley animate__animated animate__rubberBand">
            Good job! 😊
          </div>
        ) : (
          <div>&nbsp;</div>
      ...
      <div className="code-block-container">
        <CodeBlock
          className={userType + "-code-content"}
          // codeString={userType === "student" ? codeQuestion : codeAnswer}
          codeString={codeAnswer}
